	...
	return (
		<div className="HomePage">
			<header className="hero">
				...
				<p className="h-sub-text">I am an enthusiastic and dedicated Front-End Web Developer with a strong foundation in HTML, CSS, and JavaScript. I have experience with WordPress, React.js, and Next.js. My passion for web development and design, along with hands-on experience from personal projects, drives my continuous growth in the field.</p>
				...
				<p className="h-sub-text">In addition to my experience in tech, I have worked as a lumberjack and have performed accounting tasks for a company using FabricAi and Procountor. I enjoy working both collaboratively and independently.</p>
				<div className="icons">
					<a
